<?php
require __DIR__ . '/includes/session_admin.php'; // ensures session + role
require_admin();

require __DIR__ . '/includes/db.php';            // provides $dbc (mysqli)

// Search (prepared) or list all
$searchTerm = '';
...
<head>
	...
	<style type="text/css">
		...
		.title{margin-top:50%}
		#verify_courses{width:250px;padding:28px;border-radius:10px;border:2px solid #55AF55;font-size:15px;color:#272529;font-family:cursive;margin-left:42%;box-shadow:2px 2px 5px grey}
		#verify_courses:hover{background-image:linear-gradient(to right,#FA4B37,#DF2771);box-shadow:5px 5px 10px black;border:none}
...
<header id="header">
	...
	<div class="head-container">
		...
		<div><a id="verify_courses" href="verify_courses.php">Verify Courses</a></div>
		<br><br><br><br><br>
